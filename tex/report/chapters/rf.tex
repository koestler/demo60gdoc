...
for 256 \gls{QAM}. \todo{reference to results here?} \\
...
As we can see in \figref{fig:rx_2_freq_rx_if1_cos} the \gls{TX} \gls{LO}
...
As one might notice, $d$ could also be chosen


See \figref{fig:rx_adc_1_freq_sin} and \figref{fig:rx_adc_1_freq_cos}
...
\begin{figure}[h!]
  ...
  \begin{subfigure}{\textwidth}
    \centering
    %\includegraphics[width=0.45\textwidth]{figures/rx_2_freq_rx_if1_cos}
  ...
  \begin{subfigure}{\textwidth}
    \centering
    %\includegraphics[width=0.45\textwidth]{figures/rx_2_freq_rx_if1_sin}

...
The \gls{ADC} Reference Board (see \secref{Adc12d1800rf}) is connected
...
These IN\_FIFO also support an independed input and output clock.
...
(see \figref{fig:fpga_reaack_breaker}) in series for each of the four channels.
...
\figref{fig:fpga_clock_domains}. Except for parts of the \acrshort{IO} interfaces,
